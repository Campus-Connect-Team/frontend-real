  ...
  return (
    <>
      ...
      <Modal>
        ...
        <FormContainer>
          <QuesContainer>
            <div>구매자는 협의된 장소 / 약속 시간을 준수했나요?</div>
            <BtnContainer>
              <StyledButton
                type="button"
          ...
          <QuesContainer>
            <div>채팅 응답이 빨라서 거래 협의가 원활했나요?</div>
            <BtnContainer>
              <StyledButton
                type="button"
          ...
          <QuesContainer>
            <div>다음에도 기회가 된다면 이 구매자분과 거래하고 싶으신가요?</div>
            <BtnContainer>
              <StyledButton
                type="button"
